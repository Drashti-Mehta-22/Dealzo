    ...
    <main className="min-h-screen bg-linear-to-br from-orange-50 via-white to-orange-50">
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-orange-50 border border-orange-200 text-orange-700 px-6 py-2 rounded-full text-sm font-medium mb-6">
            Track 💰 Prices for your Favorite Products
          </div>
          ...
          {/* Feature section will be shown before signing in - after signing in Products will be shown */}
