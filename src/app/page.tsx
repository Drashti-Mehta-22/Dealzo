      ...
      <section className="max-w-7xl mx-auto px-4 pb-20">
        ...
        <div className="grid gap-6 md:grid-cols-2 items-start">
          {products.map((product) => (
            <div
              key={product.id}
              className="group rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-sm hover:shadow-[0_0_30px_rgba(255,115,0,0.2)] transition-all duration-300 hover:-translate-y-1"
            >
